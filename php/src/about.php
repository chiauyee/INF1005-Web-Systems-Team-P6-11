        ...
        <div class="row g-5 align-items-center">
          ...
          <div class="col-lg-6 order-lg-2 order-1">
            <div class="story-img-wrap">
              <img src="https://images.unsplash.com/photo-1483412033650-1015ddeb83d1?w=900&q=80"
                alt="A person browsing a crate of vinyl records in a warm, well-lit record shop" loading="lazy">
            </div>
          </div>
