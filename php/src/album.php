            ...
            <div class="row g-5">
                    ...
                    <section id="comments-section">
                        ...
                        <?php if ($logged_in): ?>
                            <div class="card mb-4 border-0"
                                style="border: 1.5px solid var(--border) !important; border-radius: 8px;">
                                <div class="card-body p-4">
                                    ...
                                    <textarea id="comment-input" class="form-control mb-3 bg-light border-0" rows="3"
                                        maxlength="2000" placeholder="Share your thoughts on this album..."
                                        style="resize: none;"></textarea>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <span id="comment-status" class="text-muted small fw-medium"></span>
                                        <button type="button" id="btn-comment"
                                            class="btn btn-dark px-4 rounded-pill fw-medium shadow-sm">Post Comment</button>
                                    </div>
                                </div>
                            </div>
                        <?php else: ?>
                            <div class="alert bg-white" style="border: 1.5px dashed var(--border); border-radius: 8px;">
                                <i class="bi bi-info-circle me-2 text-muted"></i> <a href="login.php"
                                    class="text-dark fw-bold text-decoration-underline text-underline-offset-4">Log in</a>
                                to leave a comment.
                            </div>
                        <?php endif; ?>
                ...
                <div class="col-lg-4">
                    <section id="images-section">
                        ...
                        <?php if ($logged_in): ?>
                            <div class="card mb-4 border-0"
                                style="border: 1.5px solid var(--border) !important; border-radius: 8px; background: #fafafa;">
                        ...
                        <?php else: ?>
                            <div class="alert bg-white small mb-4"
                                style="border: 1.5px dashed var(--border); border-radius: 8px;">
                                <a href="login.php"
                                    class="text-dark fw-bold text-decoration-underline text-underline-offset-4">Log in</a>
                                to upload photos.
                            </div>
